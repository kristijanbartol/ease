...
output_path = "/Users/kristijanbartol/simulated.ply"
...
bpy.ops.import_mesh.ply(filepath=body_path)
body = bpy.context.selected_objects[0]
body.name = "Body"

# Import the garment mesh
bpy.ops.import_mesh.ply(filepath=garment_path)
...
bpy.ops.export_mesh.ply(filepath=output_path, use_mesh_modifiers=True)

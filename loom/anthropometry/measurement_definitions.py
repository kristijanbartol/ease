...
MEASUREMENT_TYPES = {
        ...
        "wrist circumference": MeasurementType.CIRCUMFERENCE,
        "bicep circumference": MeasurementType.CIRCUMFERENCE,
        "forearm circumference": MeasurementType.CIRCUMFERENCE,
        "arm length": MeasurementType.LENGTH,
        "inside leg height": MeasurementType.LENGTH,
        "thigh circumference": MeasurementType.CIRCUMFERENCE,
        "calf circumference": MeasurementType.CIRCUMFERENCE,
        "ankle circumference": MeasurementType.CIRCUMFERENCE,
...
class SMPLMeasurementDefinitions():
    ...
    CIRCUMFERENCES = {
        ...
        "wrist circumference":{"LANDMARKS":["RIGHT_WRIST"],
                                    "JOINTS":["right_wrist","right_hand"]},
        
        "bicep circumference":{"LANDMARKS":["RIGHT_BICEP"],
                                    "JOINTS":["right_shoulder","right_elbow"]},

        "forearm circumference":{"LANDMARKS":["RIGHT_FOREARM"],
                                        "JOINTS":["right_elbow","right_wrist"]},
        
        "thigh circumference":{"LANDMARKS":["LEFT_THIGH"],
                                    "JOINTS":["pelvis","spine3"]},
        
        "calf circumference":{"LANDMARKS":["LEFT_CALF"],
                                    "JOINTS":["pelvis","spine3"]},

        "ankle circumference":{"LANDMARKS":["LEFT_ANKLE"],
                                    "JOINTS":["pelvis","spine3"]},      
    ...
    CIRCUMFERENCE_TO_BODYPARTS = {
        ...
        "wrist circumference":["rightHand","rightForeArm"],
        "bicep circumference":"rightArm",
        "forearm circumference":"rightForeArm",
        "thigh circumference": "leftUpLeg",
        "calf circumference": "leftLeg",
        "ankle circumference": "leftLeg",
    }
